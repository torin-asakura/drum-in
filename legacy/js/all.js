  ...
  (function (e, t, n) {
              ...
              ((e.attrHooks[c] = {
                get: function (t, r) {
                  var a,
                    i = e.prop(t, r)
                  return i === !0 ||
                    ('boolean' != typeof i && (a = t.getAttributeNode(r)) && a.nodeValue !== !1)
                    ? r.toLowerCase()
                    : n
                },
                set: function (t, n, r) {
    ...
    e.fn.data = function (t) {
      ...
      return !o ||
        'events' !== t ||
        1 !== arguments.length ||
        ((a = e.data(o, t)), (i = e._data(o, t)), (a !== n && a !== i) || i === n)
    ...
    var Modal =
      ...
      (function () {
        ...
        _proto.hide = function hide(event) {
          ...
          this._isShown = false
          var transition =
            Util.supportsTransitionEnd() && $$$1(this._element).hasClass(ClassName.FADE)
        ...
        _proto._resetScrollbar = function _resetScrollbar() {
          ...
          $$$1(Selector.STICKY_CONTENT + ', ' + Selector.NAVBAR_TOGGLER).each(function (
            index,
            element
          ) {
      ...
      (function () {
        ...
        _proto.show = function show() {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var container =
              this.config.container === false ? document.body : $$$1(this.config.container)
