        ...
        <Row style={{ border: '1px solid black' }}>
          ...
          <Column style={{ border: '1px solid black' }}>
            ...
            <Layout style={{ border: '1px solid black' }}>
              <Column>
                <Layout>{intl.formatMessage(messages.orchestra)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.jazz)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.blues)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.rock)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.raggey)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.trance)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.ethnic)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.girlsCover)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.albums)}</Layout>
                <Layout flexBasis={20} />
                <Layout>{intl.formatMessage(messages.groups)}</Layout>
              </Column>
            </Layout>
            <Layout flexBasis={82} />
          </Column>
