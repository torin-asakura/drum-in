...
const CourseDescription: FC = () => {
  ...
  return (
    <Box width={['320px','320px','1440px']} height={['290px','290px','722px']} border='1px solid black'>
      ...
      <Row>
        <Column alignItems='center'>
          ...
          <Box width={['280px','280px','572px']} height={['145px','145px','311px']} border='1px solid black'>
            <Layout>
              <Text>text</Text>
            </Layout>
          </Box>
        ...
        <Column>
          <Layout flexBasis={65} />
          <Box width='494px' height='596px' border='1px solid black' display={['none','none','flex']}>
            <Layout>photo</Layout>
          </Box>
        </Column>
      </Row>
