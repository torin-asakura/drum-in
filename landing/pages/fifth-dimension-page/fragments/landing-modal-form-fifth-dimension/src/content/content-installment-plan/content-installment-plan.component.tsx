...
const ContentInstallmentPlan: FC<ContentInstallmentPlanProps> = ({ fifthDimensionData }) => {
  const { formatMessage } = useIntl()
  const monthCount = fifthDimensionData?.individualCourseData?.price?.courseLengthInMonths
  const monthlyPrice = fifthDimensionData?.individualCourseData?.price?.monthlyPrice
  const courseLengthInMonths = fifthDimensionData?.individualCourseData?.price?.courseLengthInMonths
