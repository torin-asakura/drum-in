      ...
      >
        ...
        <Row>
          ...
          <Column alignItems='end'>
            <Box>
              ...
              >
                <FormattedMessage
                  id='landing_program_connacol.sixteenth_online_lessons'
            ...
            <Box>
              ...
              >
                <FormattedMessage
                  id='landing_program_connacol.four_months'
        ...
        <Row>
          ...
          <Box flexDirection='column' height={[85, 110, 0]}>
            {formatMessage({
              id: 'landing_program_connacol.connacol_three',
        ...
        <Row>
          ...
          <Box flexDirection='column' height={[68, 100, 0]}>
            {formatMessage({
              id: 'landing_program_connacol.connacol_one',
        ...
        <Row>
          ...
          <Box flexDirection='column' height={[85, 110, 0]}>
            {formatMessage({
              id: 'landing_program_connacol.connacol_five',
