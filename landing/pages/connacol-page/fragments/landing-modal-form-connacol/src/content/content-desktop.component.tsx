  ...
  <>
    ...
    >
      <Box width={['100%', 419, 419]}>
        ...
        >
          <FormattedMessage
            id='landing_modal_form_connacol.buy_a_course'
            defaultMessage='Купить курс “Коннакол”'
          />
        </Text>
      </Box>
    ...
    <Row alignItems='end'>
      ...
      >
        <Text fontWeight='medium' fontSize='medium' lineHeight='medium' color='text.smokyWhite'>
          <FormattedMessage
            id='landing_modal_form_connacol.benefit_seven_percent'
            defaultMessage='Выгода 7%'
          />
        </Text>
      </Box>
    </Row>
