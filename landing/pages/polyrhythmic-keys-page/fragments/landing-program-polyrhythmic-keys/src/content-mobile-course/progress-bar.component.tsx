...
// const progressRef = useRef<Element>(null)
...
//   const dashOffset = parseInt(getComputedStyle(progressRef.current).strokeDashoffset)
//   const heightSvg = parseInt(getComputedStyle(svgRef.current).height)
...
//       el.style.fill = y - heightWindow / 2 <= 0 ? '#f2f2f2' : '#807f7f'
//     })
//     const { y } = progressRef.current.getBoundingClientRect()
//     const percentageComplete = ((y - heightWindow / 2) / (heightSvg - 65)) * 100
//     const offsetUnit = (percentageComplete * dashOffset) / 100
//     progressRef.current.style.strokeDashoffset = dashOffset - offsetUnit
//   }
// }

// useEffect(() => {
//   document.addEventListener('touchmove', renderProgress())
// }, [])
