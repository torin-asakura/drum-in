      ...
      <Column alignItems={['start', 'start', 'center']} width='100%'>
        ...
        <Title
          currency={formatMessage({
            id: 'landing_price_seventh_heaven.eight_thousand_seven_hundred',
            defaultMessage: '8 700',
          })}
          costPerMonth={formatMessage({
            id: 'landing_price_seventh_heaven.rubles_per_month',
            defaultMessage: '₽/мес',
          })}
        />
        ...
        <Specifications
          quantityMonths={formatMessage({
            id: 'landing_price_seventh_heaven.five',
            defaultMessage: '5',
          })}
          quantityVideoLessons={formatMessage({
            id: 'landing_price_seventh_heaven.thirteen',
            defaultMessage: '13',
          })}
          firstLineCircle={formatMessage({
            id: 'landing_price_seventh_heaven.twenty',
            defaultMessage: '20',
          })}
          secondLineCircle={formatMessage({
            id: 'landing_price_seventh_heaven.live_broadcasts',
        ...
        <FullPrice
          fullCost={formatMessage({
            id: 'landing_price_seventh_heaven.entire_course_for',
        ...
        <Box>
          ...
          >
            ...
            <Text color='text.green'>
              <FormattedMessage
                id='landing_price_seventh_heaven.three_thousand_five_hundred'
