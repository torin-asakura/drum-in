...
const ContentInstallmentPlan = () => {
  ...
  return (
    <>
      <SelectedCourse
        title={formatMessage({
          id: 'landing_modal_form_seventh_heaven.seventh_heaven',
          defaultMessage: '“Седьмое небо”',
        })}
        description={formatMessage({
          id: 'landing_modal_form_seventh_heaven.course_for_experienced_musician',
          defaultMessage:
      ...
      <Row>
        <Column>
          ...
          <Box>
            ...
            >
              <FormattedMessage
                id='landing_modal_form_seventh_heaven.eight_thousand_seven_hundred'
        ...
        <Column>
          ...
          <Box>
            ...
            >
              <FormattedMessage
                id='landing_modal_form_seventh_heaven.five_months'
        ...
        <Column>
          ...
          <Box>
            ...
            >
              <FormattedMessage
                id='landing_modal_form_seventh_heaven.forty_three_thousand_five_hundred'
