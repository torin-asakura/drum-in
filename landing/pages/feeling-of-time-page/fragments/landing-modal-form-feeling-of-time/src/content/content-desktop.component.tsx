  ...
  <>
    ...
    >
      <Box width={['100%', 419, 419]}>
        ...
        >
          <FormattedMessage
            id='landing_modal_form_feeling_of_time.buy_a_course'
            defaultMessage='Купить курс “Ощущение времени”'
          />
        </Text>
      </Box>
    ...
    <Row alignItems='end'>
      ...
      >
        <Text fontWeight='medium' fontSize='medium' lineHeight='medium' color='text.smokyWhite'>
          <FormattedMessage
            id='landing_modal_form_feeling_of_time.benefit_nine_percent'
