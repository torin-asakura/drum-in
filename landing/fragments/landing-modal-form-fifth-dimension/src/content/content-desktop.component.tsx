  ...
  <>
    ...
    >
      <Box width={['100%', 419, 419]}>
        ...
        >
          <FormattedMessage
            id='landing_modal_form_fifth_dimension.buy_a_course'
            defaultMessage='Купить курс “Пятое измерение”'
          />
        </Text>
      </Box>
    ...
    <Row alignItems='end'>
      ...
      >
        <Text fontWeight='medium' fontSize='medium' lineHeight='medium' color='text.smokyWhite'>
          <FormattedMessage
            id='landing_modal_form_fifth_dimension.benefit_nine_percent'
