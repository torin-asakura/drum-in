...
import { IndividualCourseWithChoiceContentProps } from './individual-course-with-choice-content.interfaces'

const MobileIndividualCourseWithChoiceContent: FC<IndividualCourseWithChoiceContentProps> = ({
  roleVar,
  options,
  setRole,
  title,
...
export { MobileIndividualCourseWithChoiceContent }
